                ...
                <div class="row row-sm">
                    <div class="col-md-12 col-lg-12 col-xl-12">
                        <div class="card custom-card">
                            <div class="card-body">
                                <form class="base-form" action="{{route('users.store')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <select class="form-control select select2" name="province1" onChange="updateCityOptions('city1', this.value);">
                                            ...
                                            @foreach ($provinces as $province)
                                                <option value="{{ $province->id }}"
                                                    {{ old('province1') == $province->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-3 mg-t-20 mg-lg-t-0 radio-wrapper">
                                        ...
                                        <label class="rdiobox">
                                            ...
                                            {{ old('marriage') == 'single' ? 'checked' : '' }}><span>مجرد</span>
                                        ...
                                        <input type="radio" name="marriage" value="married"
                                            {{ old('marriage') == 'married' ? 'checked' : '' }}><span>متاهل</span>
